...
export async function createSocialLink(formData: FormData) {
  ...
  try {
    ...
    if (!res.ok) return { error: data?.message || "Gagal menambah tautan sosial" };
...
export async function updateSocialLink(formData: FormData) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal memperbarui tautan sosial" };
    revalidatePath("/dashboard/links");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}
...
export async function deleteSocialLink(id: number) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal menghapus tautan sosial" };
    revalidatePath("/dashboard/links");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}
...
export async function createExternalLink(formData: FormData) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal menambah tautan eksternal" };
    revalidatePath("/dashboard/links");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}
...
export async function updateExternalLink(formData: FormData) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal memperbarui tautan eksternal" };
    revalidatePath("/dashboard/links");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}
...
export async function deleteExternalLink(id: number) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal menghapus tautan eksternal" };
    revalidatePath("/dashboard/links");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}
...
export async function updateWebsiteFeature(featureId: number, formData: FormData) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal memperbarui fitur website" };
...
export async function bulkUpdateWebsiteFeatures(payload: any) {
  ...
  try {
    ...
    const data = await res.json().catch(() => null);
    if (!res.ok) return { error: data?.message || "Gagal memperbarui status secara massal" };
    revalidatePath("/dashboard/features");
    return { success: true };
  } catch { return { error: "Terjadi kesalahan jaringan" }; }
}